      ...
      <Content>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add bed assign</h5>
              <div className="mt-4">
                <Form className="row gy-4" onSubmit={handleSubmit(onFormSubmit)}>
                  ...
                  <Col md="6">
                    <div className="form-group">
                      {/* <label className="form-label">Deadline Dathgjhke</label> */}
                      <DatePicker
                  ...
                  <Col md="6">
                    <div className="form-group">
                      {/* <label className="form-label">Team Muhhembers</label> */}
                      <RSelect options={teamList} isMulti onChange={(e) => setFormData({ ...formData, team: e })} />
                    </div>
                  </Col>
                  <Col md="6">
                    <div className="form-group">
                      {/* <label className="form-label">Lejhjhkjad</label> */}
            ...
            <div className="p-2">
              ...
              <div className="mt-4">
                ...
                <Form className="row gy-4" onSubmit={handleSubmit(onEditSubmit)}>
                  <Col md="6">
                    <div className="form-group">
                      {/* <label className="form-label">Membehjr</label> */}
                      <input
                        type="text"
                        name="title"
                        defaultValue={formData.title}
                  ...
                  <Col md="6">
                    <div className="form-group">
                      {/* <label className="form-label">Cliehbjbjmnt</label> */}
                      <input
                        type="text"
                        name="subtitle"
                        defaultValue={formData.subtitle}
                  ...
                  <Col size="12">
                    <div className="form-group">
                      {/* <label className="form-label">Description jhjgjhgj</label> */}
                      <textarea
                        name="description"
                        defaultValue={formData.description}
                        placeholder="Your description"
