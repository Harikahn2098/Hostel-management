...
import Bed from "../pages/pre-built/Bed Manager/Bed/Bed";
import Room from "../pages/pre-built/Bed Manager/Room/Room";
import RoomCategory from "../pages/pre-built/Bed Manager/RoomCategory/RoomCategory";
import BedAssign from "../pages/pre-built/Bed Manager/BedAssign/BedAssign";
import Members from "../pages/pre-built/Members/Members";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        {/*Pre-built Pages*/}
        <Route exact path={`${process.env.PUBLIC_URL}/project-card`} component={BedAssign}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/bed-assign`} component={ProjectListPage}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/bed-manager-bed`} component={Bed}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/bed-manager-room`} component={Room}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/bed-manager-category`} component={RoomCategory}></Route>


        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/user-list-regular`}
          // component={UserListRegularPage}
